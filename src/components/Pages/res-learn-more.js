...
const ResLearnMore = () => {
    ...
    useEffect(() => {
        axios.get(`https://api.prestigemotorsvence.com/api/restoration/${id}`)
            .then(res => {
                setCar(res.data);
                    ...
                    <div className='car-learn-more-bg-con'>
                        <div className="car-learn-more">
                            <div className="car-left-column">
                                <h1>{car.carName}</h1>
                                <div className='car-learn-more-call-box'><p className='car-learn-more-call-p'>APPELEZ POUR LES PRIX</p></div>
                                ...
                                <div className="rectangle-box">
                                    <div className='rec-box-row-one'>
                                        ...
                                        <div className='rec-box-set-one'><p className="car-learn-more-bold-text">KILOMÉTRAGE</p>
                                            <p className='car-learn-more-text'>{car.mileage}</p>
                                        </div>
                                    </div>

                                    <div className='rec-box-row-two'>
                                        <div className='rec-box-set-one'><p className="car-learn-more-bold-text">COULEUR EXTÉRIEURE</p>
                                            <p className='car-learn-more-text'>{car.exteriorColor}</p>
                                        </div>
                                        <div className='rec-box-set-one'><p className="car-learn-more-bold-text">COULEUR INTÉRIEURE</p>
